...
sce <- readH5AD("../../data/BMMC/s1d1/GASM/rna.h5ad")
...
sce2 <- readH5AD("../../data/BMMC/s1d1/GASM/atac.h5ad")
...
frag.file <- "../../data/BMMC/s1d1/bmmc_site1_or_donor1_atac_fragments.tsv.gz"
