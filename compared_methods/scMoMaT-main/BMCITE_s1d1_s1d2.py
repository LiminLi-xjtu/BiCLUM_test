...
species = 'Human' 
adata_rna = sc.read_h5ad('../../data/BMCITE_s1d1_s1d2/bm.rna.s1d1_s1d2_new.h5ad')
adata_adt = sc.read_h5ad('../../data/BMCITE_s1d1_s1d2/bm.adt.s1d1_s1d2_new.h5ad')
fea_pairs = pd.read_csv('../../data/BMCITE_s1d1_s1d2/graph.csv')
